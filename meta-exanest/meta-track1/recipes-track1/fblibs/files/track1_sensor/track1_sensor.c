...
//int
//track1_sensor_sdr_init(uint8_t fru, sensor_info_t *sinfo) {
  //int fd;
  //uint8_t buf[MAX_SDR_LEN] = {0};
  //uint8_t bytes_rd = 0;
  //uint8_t sn = 0;
...
//int
//track1_sensor_units(uint8_t fru, uint8_t sensor_num, char *units) {
  //uint8_t op, modifier;
  //sensor_info_t *sinfo;
...
//int
//track1_sensor_threshold(uint8_t fru, uint8_t sensor_num, uint8_t thresh, float *value) {
...
//int
//track1_sensor_name(uint8_t fru, uint8_t sensor_num, char *name) {
...
//int
//track1_sensor_read(uint8_t fru, uint8_t sensor_num, void *value) {
