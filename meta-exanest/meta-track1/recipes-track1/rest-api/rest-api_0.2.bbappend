...
binfiles += "setup-rest-api.sh plat_tree.py node_api.py node_spb.py node_mezz.py \
          node_bmc.py node_server.py node_fruid.py node_sensors.py node_logs.py \
          node_config.py node_tpdb.py \
          "
