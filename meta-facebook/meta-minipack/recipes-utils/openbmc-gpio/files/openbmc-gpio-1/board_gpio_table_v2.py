...
board_gpio_table_v2 = [
    ...
    BoardGPIO('GPIOF0', 'BMC10_9548_1_RST'),
    ...
    BoardGPIO('GPIOH0', 'GPIOH0'),
    BoardGPIO('GPIOH1', 'GPIOH1'),
    BoardGPIO('GPIOH2', 'GPIOH2'),
    BoardGPIO('GPIOH3', 'GPIOH3'),
    BoardGPIO('GPIOH4', 'GPIOH4'),
    BoardGPIO('GPIOH5', 'GPIOH5'),
    BoardGPIO('GPIOH6', 'GPIOH6'),
    BoardGPIO('GPIOH7', 'GPIOH7'),
    ...
    BoardGPIO('GPION0', 'BMC_PIM1_9548_RST_N'),
    BoardGPIO('GPION1', 'BMC_PIM2_9548_RST_N'),
    BoardGPIO('GPION2', 'BMC_PIM3_9548_RST_N'),
    BoardGPIO('GPION3', 'BMC_PIM4_9548_RST_N'),
    BoardGPIO('GPION4', 'BMC_PIM5_9548_RST_N'),
    BoardGPIO('GPION5', 'BMC_PIM6_9548_RST_N'),
    BoardGPIO('GPION6', 'BMC_PIM7_9548_RST_N'),
    BoardGPIO('GPION7', 'BMC_PIM8_9548_RST_N'),
    ...
    BoardGPIO('GPIOP2', 'BMC_RST_FPGA'),
    BoardGPIO('GPIOR2', 'BMC_SPI2_CS0'),
    BoardGPIO('GPIOR3', 'BMC_SPI2_CLK'),
    BoardGPIO('GPIOR4', 'BMC_SPI2_MOSI'),
    BoardGPIO('GPIOR5', 'BMC_SPI2_MISO'),
    BoardGPIO('GPIOR6', 'BMC_SW_MDC1'),
    BoardGPIO('GPIOR7', 'BMC_SW_MDIO1'),
    BoardGPIO('GPIOS0', 'BMC_SPI2_CS1'),
    ...
    BoardGPIO('GPIOS6', 'BMC9_9548_0_RST'),
